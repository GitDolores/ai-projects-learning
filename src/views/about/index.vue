...
const words = ['@pureadmin/descriptions', '@pureadmin/table', '@pureadmin/utils', '@vueuse/core', 'axios', 'dayjs', 'echarts', 'vue', 'element-plus', 'pinia', 'vue-i18n', 'vue-router', '@iconify/vue', '@vitejs/plugin-vue', '@vitejs/plugin-vue-jsx', 'eslint', 'prettier', 'sass', 'stylelint', 'tailwindcss', 'typescript', 'vite', 'vue-tsc']
...
<template>
    <div>
        <el-card
            ...
            shadow="never"
        >
            <span> vue-pure-admin 是一款开源免费且开箱即用的中后台管理系统模版。完全采用 ECMAScript 模块（ESM）规范来编写和组织代码，使用了最新的 Vue3、Vite、Element-Plus、TypeScript、Pinia、Tailwindcss 等主流技术开发。 </span>
        </el-card>
