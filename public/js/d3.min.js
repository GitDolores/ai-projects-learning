!(function () {
    ...
    function qt() {
        var n = Lt(),
            t = Tt() - n;
        t > 24
            ? (isFinite(t) && (clearTimeout(ic), (ic = setTimeout(qt, t))),
              (uc = 0))
            : ((uc = 1), ac(qt));
    }
    function Lt() {
    ...
    function iu(n, t) {
        var e,
            ...
            i = n.sort(ou).pop();
        for (
            tl = [], el = new Array(n.length), rl = new nu(), il = new nu();
            ;
    ...
    function Yo(n) {
        return function () {
            ...
            (t = this[n]) &&
                (e = t[t.active]) &&
                (--t.count
                    ? (delete t[t.active], (t.active += 0.5))
                    : delete this[n],
                e.event &&
