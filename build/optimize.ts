 ...
 */
const include = ['qs', 'mitt', 'xlsx', 'dayjs', 'axios', 'pinia', 'vditor', 'typeit', 'swiper', 'qrcode', 'intro.js', 'vue-i18n', 'deep-chat', 'vxe-table', 'vue-types', 'js-cookie', 'vue-tippy', 'cropperjs', 'jsbarcode', 'codemirror', 'pinyin-pro', 'sortablejs', 'swiper/vue', 'mint-filter', 'highlight.js', '@vueuse/core', 'vue3-danmaku', 'v-contextmenu', 'vue-pdf-embed', 'wavesurfer.js', 'swiper/modules', 'china-area-data', 'vue-json-pretty', '@logicflow/core', '@pureadmin/utils', '@wangeditor/editor', 'responsive-storage', 'plus-pro-components', '@howdyjs/mouse-menu', '@logicflow/extension', 'vue-virtual-scroller', 'codemirror-editor-vue3', '@amap/amap-jsapi-loader', 'el-table-infinite-scroll', 'vue-waterfall-plugin-next', '@infectoone/vue-ganttastic', '@wangeditor/editor-for-vue', 'vuedraggable/src/vuedraggable']
